const navigation = {
  ...
  socials: [
    ...
    {
      name: "Linkedin",
      href: "https://www.linkedin.com/company/buildwithsygma",
      icon: (props: any) => (
        <svg
          role="img"
          viewBox="0 0 24 24"
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-gray-300">
              Stay up to date about software updates, latest product features
              and news.
            </p>
          </div>
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full min-w-0 appearance-none rounded-md border-0 bg-white/5 px-3 py-1.5 text-base text-white shadow-sm ring-1 ring-inset ring-white/10 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-primary-100 sm:w-56 sm:text-sm sm:leading-6"
              placeholder="Enter your email"
            />
            <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
              <button
                type="submit"
                className="flex w-full items-center justify-center rounded-md bg-primary-100 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-100"
              >
                Subscribe
              </button>
            </div>
          ...
          <div className="flex space-x-6 md:order-2">
            {navigation.socials.map((item) => (
              ...
              >
                ...
                <item.icon
                  className="h-6 w-6 fill-primary-100 brightness-75 hover:brightness-100"
                  aria-hidden="true"
                />
              </a>
            ))}
