    ...
    <article className="hero">
      <div className="hero--header">
        ...
        <div className="title-wrapper">
          ...
          <p>Sygma facilitates inter-blockchain message passing so you can build cross-chain native applications or extend an existing dApp/protocol to numerous networks at once. </p>
