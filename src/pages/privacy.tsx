      ...
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <div className="mt-10 max-w-2xl">
          ...
          <p>
            ...
            respects your privacy and is committed to protecting it by complying
            with this policy. This privacy policy (
            <span className="font-medium">“Privacy Policy”</span>) describes how
            we collect, use, disclose and protect your personal data.
          </p>
          <p className="my-4">
            We will only use your personal data in accordance with this policy
            unless otherwise required by applicable law. We take steps to ensure
            that the personal data that we collect about you is adequate,
            relevant, not excessive, and used for limited purposes. This policy
            applies to information we collect, use or disclose about you on this
            website (the “Services”) or through any email, text or email between
          ...
          <p className="my-4">
            ...
            not to use the Services. By accessing or using the Services, you
            indicate that you understand, accept, and consent to the practices
            described in this policy. This policy may change from time to time.
            Your continued use of the Services after we make changes indicates
          ...
          <p className="my-4">
            ...
            transactions that relates directly or indirectly to a data subject,
            who is identified or identifiable from that information, or from
            that and other information in the possession of a data user,
            including any sensitive personal data and expression of opinion
            about the data subject. The personal data we collect about you
          ...
          >
            ...
            <li className="flex gap-x-3">
              login information (including your web3 wallet provider and public
              address), browser type and version, IP address, time zone setting,
              browser plug-in types and versions, operating system, platform,
              internet connection, equipment used to access the Service and
              usage details;
            </li>
            <li className="flex gap-x-3">
            ...
            <li className="flex gap-x-3">
              data regarding your digital asset wallet, its corresponding public
              address and any relevant transactions performed through it on
              public blockchains;
            </li>
            <li className="flex gap-x-3">
              feedback or information you provide to us through the Services or
              email relating to the Services.
            </li>
          </ol>
          <p className="my-4">
            ...
            (a) - e)) from these blockchains and third-party services providers
            as may be required to operate the Services).
          </p>
          ...
          <ul className="ml-6 mt-8 max-w-xl list-decimal space-y-8 ">
            ...
            <li>
              automated technologies. As you use the Services, personal data may
              automatically be collected, including usage details, IP address,
          ...
          <p className="my-4">
            ...
            third-party service providers that integrate with the Services. Some
            ways we may collect your personal data include:
          </p>
          <ol className="disc">
            <li>
              <strong>Public Blockchains:</strong> If you access the Services
              through a public blockchain, we may collect personal data that is
              accessible from that blockchain and necessary to interact with
              your web3 wallet.
            </li>
            <li>
              <strong>Ethereum Data:</strong> If you access the Services using
              an Ethereum address, we may store the Ethereum Address and collect
            ...
            <li>
              ...
              username from our OAuth functionality may be collected and stored.
            </li>
          </ol>
          <p className="my-4">
          ...
          <ul className="disc">
            ...
            <li>
              ...
              information through text message, email or other electronic means.
            </li>
          </ul>
          <h2 className="my-4 text-lg">
          ...
          <p className="my-4">
            ...
            and may include personal data that you provide to us or that we
            receive from third parties. It helps us to improve the Services and
            to deliver a better and more personalized functionality, including
            by enabling us to:
          </p>
          <ul className="list-disc">
            ...
            <li>
              ...
              the Services according to your interests.
            </li>
          ...
          <p>
            We use the personal data we collect about you or that you provide to
            us through providing the Services. We may use your personal data:
          </p>
          <ul>
            <li>
              To present the Services and its contents to you. We do not monitor
              or track personal data provided to the Services except as required
              by law.
            </li>
            <li>
              To provide you with the information, modifications to the
              Services, products and functionality you may request from us.
              Personal data may be used to provide a personalized experience and
              facilitate payments on the Services. To fulfil the purposes for
              which you provided your personal data or that we
            </li>
            <li>
              To fulfil the purposes for which you provided your personal data
              or that were described when it was collected, or any other purpose
            ...
            <li>
              ...
              applicable laws, regulations, directives or requests from relevant
              authorities.
            </li>
            <li>
            ...
            <li>
              ...
              instructions, directives, and other requests from law enforcement,
              governmental authorities or regulating bodies; or
            </li>
            <li>
          ...
          <p className="my-4">
            We may also use your personal data to contact you about our own and
            third-parties' services that may be of interest to you, as permitted
            by law. If you do not want us to use your personal data in this way,
            we will give you the opportunity to opt-out of receiving these
            communications.
          </p>
          <h2 className="my-4 text-lg">6. Disclosure of Your Personal Data</h2>
          <p>
            We may disclose aggregated anonymized personal data about our users,
            and personal data that does not identify any individual, without
            restriction.
          </p>
          <p className="my-4">
            We may disclose personal data that we collect or that you provide as
          ...
          <ol>
            ...
            <li>
              ...
              information with trusted service providers, contractors, the
              organizations they act on behalf of, and other third-parties (such
              as decentralized protocols) that we use to support our business.
              These third-party service providers may require us to provide them
              with your information to perform or facilitate these functions. If
              we provide them with your information, we will contractually
              obligate them to keep your information confidential, use it only
              for the purposes for which we disclose it to them, and to process
              the personal data with the same standards set out in this policy.
            </li>
            <li>
              <strong>Payment Processors: </strong>Users may be able to submit
              payment information into the Service to pay for certain features.
              Sygma may utilize third-party payment processors to facilitate
              payments. We do not receive nor store any payment information on
              our servers. All payment transactions are encrypted when
              communicated through our third-party payment processor.
            </li>
            <li>
            ...
            <li>
              ...
              in order to comply with any court order, law, or legal process,
          ...
          <p>
            We may transfer personal data that we collect or that you provide as
            ...
            to keep personal data confidential, use it only for the purposes for
            which we disclose it to them, and to process the personal da with
            the same standards set out in this policy.
          </p>
          <p className="my-4">
            We may process, store, and transfer your personal data in and to a
            foreign country, with different privacy laws that may or may not be
            as comprehensive as your jurisdiction. In these circumstances, the
            governments, courts, law enforcement, or regulatory agencies of that
            country may be able to obtain access to your personal data through
            the laws of the foreign country.
          </p>
          <p className="my-4">
            Whenever we engage a service provider, we require that its privacy
            and security standards adhere to this policy and applicable privacy
            legislation.
          </p>
          <p className="my-4">
            ...
            jurisdiction. By submitting your personal data or engaging with the
            Services, you consent to this transfer, storage, or processing.
          </p>
          ...
          <p>
            ...
            access, use, alteration, and disclosure. The safety and security of
            your personal data also depends on you. Where we have given you (or
            where you have chosen) a password for access to certain parts of
            your Digital Wallet, you are responsible for keeping this password
          ...
          <p className="my-4">
            ...
            data transmitted to our Services. Any transmission of personal data
            is done at your own risk. We are not responsible for circumvention
          ...
          <p className="my-4">
            ...
            use of your personal data, you may also send us an email at
          ...
          <p className="my-4">
            ...
            personal data that we hold about you or make your requested changes.
          ...
          <p className="my-4">
            We will provide access to your personal data, subject to exceptions
            set out in applicable privacy legislation. Examples of such
            exceptions include:
          </p>
          <ul className="ml-6 mt-8 max-w-xl list-decimal space-y-8 ">
          ...
          <p className="my-4">
            ...
            provide you with a particular product or service. We will explain
          ...
          <p className="my-4">
            ...
            visiting our Services and this privacy policy to check for any
            changes.
          </p>
          <h2 className="my-4 text-lg">
          ...
          <ol>
            <li>
              ...
              and obtain access to your personal data (known as a “data subject
            ...
            <li>
              ...
              hold about you corrected, including through providing us with a
              supplementary
            </li>
            <li>
              ...
              us to continue to process it. You also have the right to ask us to
          ...
          <p className="my-4">
            ...
            inquiries about our handling of personal data, our compliance with
            this policy, and with applicable privacy laws. To discuss our
