...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-10 flex w-full flex-col justify-center space-y-2 lg:flex-row lg:items-center lg:space-y-0">
        <div className="mx-5 flex gap-x-6">
          ...
          <div>
            ...
            <div className="mt-3 px-3 py-4" id="my-hubspot-form"></div>
          </div>
        </div>
