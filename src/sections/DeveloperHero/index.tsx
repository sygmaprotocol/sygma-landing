            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Grow the pie and meet your users where they are.
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Our SDK is an abstraction layer on top of Sygma, letting you
                  easily manage the flow of data and value across networks.
                </p>
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  >
                    Apply to Builder's Program <span aria-hidden="true">→</span>
                  </a>
                </div>
              </div>
            </div>
                  ...
                  <div className="mx-auto max-w-2xl md:mx-0 md:max-w-none">
                    <div className="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                      ...
                      <div className="px-6 pb-14 pt-6">
                        {/* Your code example */}
                        {" const foo = hello World; const bar = world hello"}
                      </div>
                    </div>
                  </div>
                  <div
